...
> 历史快照说明：本文记录的是 2026-06-14 当时的审计结论。此后项目已经补齐 GitHub CI、`test-all.cmd`、`install-all.cmd`、根目录 `package.json`、发布目录同步和多项服务化能力。阅读本文时请把“缺少/未完成”类结论当作历史发现，最终状态以当前 README、CI、测试和代码为准。
