...
set "PORT=5177"
set "VLLM_MANAGER_HOST=0.0.0.0"
set "VLLM_MANAGER_PORT=5177"
set "VLLM_MANAGER_ALLOW_REMOTE=0"
...
powershell -NoProfile -ExecutionPolicy Bypass -Command ^
  ...
  "if ($listener) { throw ('Port ' + $port + ' is already in use by PID ' + $listener.OwningProcess + '. Close that process or change VLLM_MANAGER_PORT.') }" ^
...
echo vLLM Manager is available at %URL%
